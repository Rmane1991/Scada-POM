...
public class Scada_Print_Ch_Batch extends Utility
{
	...
	// **************** Reusable Input Setter **************
		private void clearAndSetBatch(String batch) throws InterruptedException 
		{
			BatchFrom.clear();
			BatchTo.clear();
